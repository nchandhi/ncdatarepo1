...
import auth.azure_credential_utils as azure_credential_utils
...
class TestAzureCredentialUtils:
    ...
    @patch("auth.azure_credential_utils.DefaultAzureCredential")
    @patch("auth.azure_credential_utils.ManagedIdentityCredential")
    ...
    @pytest.mark.asyncio
    @patch.dict(os.environ, {}, clear=True)
    @patch("auth.azure_credential_utils.AioDefaultAzureCredential")
    @patch("auth.azure_credential_utils.AioManagedIdentityCredential")
